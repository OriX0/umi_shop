 ...
 * @LastEditors: OriX
 * @LastEditTime: 2021-05-11 23:44:08
 */
...
// 获取单个商品的详情
export async function getGoodsInfo(goodId, params = null) {
  return request.get(`/api/admin/goods/${goodId}`, { params });
}
// 修改单个商品的详情
...
// 增加单个商品
export async function addGoods(goodId, params) {
  return request.post(`/api/admin/goods/${goodId}`, { params });
}
